...
const cases = [
    ...
    { title: "v0 → Figma", desc: "Vercel v0 ships React + Tailwind. Convert the rendered output into pixel-accurate, editable Figma layers — no manual rebuild.", href: "/use-cases/v0-to-figma" },
